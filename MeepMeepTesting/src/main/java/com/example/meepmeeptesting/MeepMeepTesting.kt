...
fun main(args: Array<String>) {
    ...
    // starting positions
    val blueRight = Pose2d(36.0, 60.0, down)
    val blueLeft = Pose2d(-26.0, 60.0, down)
    val redRight = Pose2d(26.0, -60.0, up)
    val redLeft = Pose2d(-36.0, -60.0, up)

    val myBot =
        DefaultBotBuilder(meepMeep) // Set bot constraints: maxVel, maxAccel, maxAngVel, maxAngAccel, track width
            .setConstraints(60.0, 60.0, Math.toRadians(180.0), Math.toRadians(180.0), 15.0)
            .setDimensions(17.0, 14.5)
            .build()

    myBot.runAction(
        myBot.drive.actionBuilder(redRight)
            .strafeTo(Vector2d(2.8, -32.0))
            .strafeTo(Vector2d(24.3, -32.0))
            .setTangent(up)
