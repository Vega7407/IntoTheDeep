...
public class AutoMovementRightSide extends LinearOpMode  {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action grabColor = bobot.drive.actionBuilder(redRight)
                ...
                .setTangent(down)
                .splineTo(new Vector2d(40.5, -45), up * 1.1)
...
//                .turnTo(down)
                ...
                .turnTo(down)
                .stopAndAdd(new SequentialAction(arm.setTarget(245), clawWrist.clawWristSet(0.21), claw.openClaw()))
                ...
                .waitSeconds(0.2)
                .stopAndAdd( slides.prepSlide())
                .strafeToConstantHeading(new Vector2d(-5, -26.2))
                .stopAndAdd(slides.clipSlide())
                .stopAndAdd(new ParallelAction(claw.openClaw(), slides.retractSlide()))
                .stopAndAdd(new ParallelAction(arm.setTarget(212), clawWrist.clawWristSet(0.21)))
