...
//                .turnTo(down)
                ...
                .stopAndAdd(slides.retractSlide())
                .turnTo(down)
                .stopAndAdd(new SequentialAction(arm.setTarget(256), clawWrist.clawWristSet(0.21), claw.openClaw()))
                .strafeTo(new Vector2d(30, -78))
                .waitSeconds(0.1)
                .stopAndAdd(claw.closeClaw())
                .waitSeconds(0.4)
                .stopAndAdd(new ParallelAction(clawWrist.clawWristUp(), arm.setTarget(340)))
                .splineToConstantHeading(new Vector2d(-15, -43.2), down)
                .stopAndAdd( slides.prepSlide())
                .waitSeconds(0.1)
                .stopAndAdd(slides.clipSlide())
                .waitSeconds(0.05)
                .stopAndAdd(new SequentialAction(new ParallelAction(claw.openClaw(), slides.retractSlide()), clawWrist.clawWristUp()))
                .stopAndAdd(new SequentialAction(claw.openClaw(), new ParallelAction(arm.setTarget(220), clawWrist.clawWristSet(0.21))))
                .strafeTo(new Vector2d(30, -78))
                .waitSeconds(0.1)
                .stopAndAdd(claw.closeClaw())
                .waitSeconds(0.4)
